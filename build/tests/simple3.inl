// simple3.inl generated by mFAST from FAST Template. 
...
inline void Test_cref::accept(Visitor& visitor)
{
  ...
  visitor.visit(ext_cref< sequence_cref, ext_cref<uint32_cref, none_operator_tag, properties_type< 1> >, ext_cref< typename sequence1_cref::reference, sequence_element_tag,properties_type< 4> > > ((*this)[1]) );
}
...
inline void Test_mref::accept(Visitor& visitor)
{
  ...
  visitor.visit(ext_mref< sequence_mref, ext_mref<uint32_mref, none_operator_tag, properties_type< 1> >, ext_mref< typename sequence1_mref::reference, sequence_element_tag,properties_type< 4> > > ((*this)[1]) );
}
