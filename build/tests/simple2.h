// simple2.h generated by mFAST from FAST Template. 
  ...
  : public mfast::aggregate_cref
{
  ...
  public:
      ...
      : public mfast::aggregate_cref
    {
      typedef mfast::aggregate_cref base_type;
      public:
        typedef mfast::group_instruction_ex<group1_cref> instruction_type;

        typedef const instruction_type* instruction_cptr;
        group1_cref();
        template <typename T>
        group1_cref(
          typename std::enable_if<std::is_same<typename T::cref_type, group1_cref>::value, const mfast::value_storage*>::type storage,
          const T* instruction);

        explicit group1_cref(const mfast::field_cref& other);
    ...
    group1_cref get_group1() const;
    group1_cref try_get_group1() const;
  ...
  : public Test_mref_base
{
  ...
  public:
    ...
    class group1_mref
      : public mfast::make_aggregate_mref<Test_cref::group1_cref>
    {
      typedef mfast::make_aggregate_mref<Test_cref::group1_cref> base_type;
      public:
        group1_mref();
        template <typename T>
        group1_mref(
          mfast::allocator*       alloc,
          typename std::enable_if<std::is_same<typename T::cref_type, group1_cref>::value, mfast::value_storage*>::type   storage,
          const T* instruction);

        explicit group1_mref(const mfast::field_mref_base& other);
    ...
    group1_mref set_group1() const;
    void omit_group1() const;
};
