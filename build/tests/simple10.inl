// simple10.inl generated by mFAST from FAST Template. 
...
inline void Test_cref::accept(Visitor& visitor)
{
  ...
  visitor.visit(ext_cref< sequence_cref, ext_cref<uint32_cref, constant_operator_tag, properties_type< 2> >, ext_cref< typename sequence1_cref::reference, sequence_element_tag,properties_type< 2> > > ((*this)[0]) );
}
...
{
  using namespace mfast;
  visitor.visit(ext_mref< sequence_mref, ext_mref<uint32_mref, constant_operator_tag, properties_type< 2> >, ext_mref< typename sequence1_mref::reference, sequence_element_tag,properties_type< 2> > > ((*this)[0]) );
}
...
{
  return static_cast<Test_cref::sequence1_cref>((*this)[0]);
}
...
{
  return static_cast<Test_mref::sequence1_mref>((*this)[0]);
}
...
Test_cref::sequence1_element_cref::get_field1() const
{
  return static_cast<mfast::int64_cref>((*this)[0]);
}

inline mfast::int64_cref
Test_cref::sequence1_element_cref::try_get_field1() const
{
  return static_cast<mfast::int64_cref>((*this)[0]);
}

inline mfast::int64_mref
Test_mref::sequence1_element_mref::set_field1() const
{
