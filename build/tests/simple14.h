// simple14.h generated by mFAST from FAST Template. 
  ...
  : public mfast::aggregate_cref
{
  ...
  public:
    ...
    class sequence_2_element_cref
      : public mfast::sequence_element_cref
    {
      typedef mfast::sequence_element_cref base_type;
      public:
        typedef mfast::sequence_instruction_ex<sequence_2_element_cref> instruction_type;
        typedef const instruction_type* instruction_cptr;
        sequence_2_element_cref(
          const mfast::value_storage* storage,
          instruction_cptr            instruction);
    ...
    typedef mfast::make_sequence_cref<sequence_2_element_cref> sequence_2_cref;
    sequence_2_cref get_sequence_2() const;
    sequence_2_cref try_get_sequence_2() const;
    mfast::uint32_cref get_field_2_3() const;
    mfast::uint32_cref try_get_field_2_3() const;
  ...
  : public Test_2_mref_base
{
  ...
  public:
    ...
    class sequence_2_element_mref
      : public mfast::make_aggregate_mref<Test_2_cref::sequence_2_element_cref>
    {
      typedef mfast::make_aggregate_mref<Test_2_cref::sequence_2_element_cref> base_type;
      public:
        sequence_2_element_mref(
          mfast::allocator*     alloc,
          mfast::value_storage* storage,
          instruction_cptr      instruction);
        ...
        void omit_field_2_2() const;
    };

    typedef mfast::make_sequence_mref<sequence_2_element_mref> sequence_2_mref;
    sequence_2_mref set_sequence_2() const;
    void omit_sequence_2() const;
    mfast::uint32_mref set_field_2_3() const;
    void omit_field_2_3() const;
};
  ...
  : public Test_4_mref_base
{
  ...
  public:
    ...
    class sequence_4_element_mref
      : public mfast::make_aggregate_mref<Test_4_cref::sequence_4_element_cref>
    {
      typedef mfast::make_aggregate_mref<Test_4_cref::sequence_4_element_cref> base_type;
      public:
    ...
    void omit_sequence_4() const;
    mfast::uint32_mref set_field_4_3() const;
    void omit_field_4_3() const;
};
  ...
  : public mfast::aggregate_cref
{
  ...
  public:
    ...
    class sequence_5_1_element_cref
      : public mfast::sequence_element_cref
    {
      typedef mfast::sequence_element_cref base_type;
      public:
        typedef mfast::sequence_instruction_ex<sequence_5_1_element_cref> instruction_type;
        typedef const instruction_type* instruction_cptr;
        sequence_5_1_element_cref(
          const mfast::value_storage* storage,
          instruction_cptr            instruction);
        ...
        mfast::uint32_cref get_field_5_4() const;
        mfast::uint32_cref try_get_field_5_4() const;

        class sequence_5_2_element_cref
          : public mfast::sequence_element_cref
        {
          typedef mfast::sequence_element_cref base_type;
          public:
            typedef mfast::sequence_instruction_ex<sequence_5_2_element_cref> instruction_type;
            typedef const instruction_type* instruction_cptr;
            sequence_5_2_element_cref(
              const mfast::value_storage* storage,
              instruction_cptr            instruction);
            ...
            mfast::uint32_cref get_field_5_6() const;
            mfast::uint32_cref try_get_field_5_6() const;
        };

        typedef mfast::make_sequence_cref<sequence_5_2_element_cref> sequence_5_2_cref;
        sequence_5_2_cref get_sequence_5_2() const;
        sequence_5_2_cref try_get_sequence_5_2() const;
    };

    typedef mfast::make_sequence_cref<sequence_5_1_element_cref> sequence_5_1_cref;
    sequence_5_1_cref get_sequence_5_1() const;
    sequence_5_1_cref try_get_sequence_5_1() const;
  ...
  : public Test_5_mref_base
{
  ...
  public:
    ...
    class sequence_5_1_element_mref
      : public mfast::make_aggregate_mref<Test_5_cref::sequence_5_1_element_cref>
    {
      typedef mfast::make_aggregate_mref<Test_5_cref::sequence_5_1_element_cref> base_type;
      public:
        sequence_5_1_element_mref(
          mfast::allocator*     alloc,
          mfast::value_storage* storage,
          instruction_cptr      instruction);
        ...
        mfast::uint32_mref set_field_5_4() const;
        void omit_field_5_4() const;

        class sequence_5_2_element_mref
          : public mfast::make_aggregate_mref<Test_5_cref::sequence_5_1_element_cref::sequence_5_2_element_cref>
        {
          typedef mfast::make_aggregate_mref<Test_5_cref::sequence_5_1_element_cref::sequence_5_2_element_cref> base_type;
          public:
            sequence_5_2_element_mref(
              mfast::allocator*     alloc,
              mfast::value_storage* storage,
              instruction_cptr      instruction);
            ...
            mfast::uint32_mref set_field_5_6() const;
        };

        typedef mfast::make_sequence_mref<sequence_5_2_element_mref> sequence_5_2_mref;
        sequence_5_2_mref set_sequence_5_2() const;
        void omit_sequence_5_2() const;
    };

    typedef mfast::make_sequence_mref<sequence_5_1_element_mref> sequence_5_1_mref;
    sequence_5_1_mref set_sequence_5_1() const;
};
  ...
  : public mfast::aggregate_cref
{
  ...
  public:
      ...
      : public mfast::aggregate_cref
    {
      typedef mfast::aggregate_cref base_type;
      public:
        typedef mfast::group_instruction_ex<group_6_cref> instruction_type;

        typedef const instruction_type* instruction_cptr;
        group_6_cref();
        template <typename T>
        group_6_cref(
          typename std::enable_if<std::is_same<typename T::cref_type, group_6_cref>::value, const mfast::value_storage*>::type storage,
          const T* instruction);

        explicit group_6_cref(const mfast::field_cref& other);

        template <typename Visitor>
        void accept(Visitor& v);


        class sequence_6_1_element_cref
          : public mfast::sequence_element_cref
        {
          typedef mfast::sequence_element_cref base_type;
          public:
            typedef mfast::sequence_instruction_ex<sequence_6_1_element_cref> instruction_type;
            typedef const instruction_type* instruction_cptr;
            sequence_6_1_element_cref(
              const mfast::value_storage* storage,
              instruction_cptr            instruction);
            ...
            mfast::uint32_cref get_field_6_4() const;
            mfast::uint32_cref try_get_field_6_4() const;

            class sequence_6_2_element_cref
              : public mfast::sequence_element_cref
            {
              typedef mfast::sequence_element_cref base_type;
              public:
                typedef mfast::sequence_instruction_ex<sequence_6_2_element_cref> instruction_type;
                typedef const instruction_type* instruction_cptr;
                sequence_6_2_element_cref(
                  const mfast::value_storage* storage,
                  instruction_cptr            instruction);
                ...
                mfast::uint32_cref get_field_6_6() const;
                mfast::uint32_cref try_get_field_6_6() const;
            };

            typedef mfast::make_sequence_cref<sequence_6_2_element_cref> sequence_6_2_cref;
            sequence_6_2_cref get_sequence_6_2() const;
            sequence_6_2_cref try_get_sequence_6_2() const;
        };

        typedef mfast::make_sequence_cref<sequence_6_1_element_cref> sequence_6_1_cref;
        sequence_6_1_cref get_sequence_6_1() const;
        sequence_6_1_cref try_get_sequence_6_1() const;
    };

    group_6_cref get_group_6() const;
    group_6_cref try_get_group_6() const;
  ...
  : public Test_6_mref_base
{
  ...
  public:
    ...
    class group_6_mref
      : public mfast::make_aggregate_mref<Test_6_cref::group_6_cref>
    {
      typedef mfast::make_aggregate_mref<Test_6_cref::group_6_cref> base_type;
      public:
        group_6_mref();
        template <typename T>
        group_6_mref(
          mfast::allocator*       alloc,
          typename std::enable_if<std::is_same<typename T::cref_type, group_6_cref>::value, mfast::value_storage*>::type   storage,
          const T* instruction);

        explicit group_6_mref(const mfast::field_mref_base& other);

        template <typename Visitor>
        void accept(Visitor& v);


        class sequence_6_1_element_mref
          : public mfast::make_aggregate_mref<Test_6_cref::group_6_cref::sequence_6_1_element_cref>
        {
          typedef mfast::make_aggregate_mref<Test_6_cref::group_6_cref::sequence_6_1_element_cref> base_type;
          public:
            sequence_6_1_element_mref(
              mfast::allocator*     alloc,
              mfast::value_storage* storage,
              instruction_cptr      instruction);
            ...
            mfast::uint32_mref set_field_6_4() const;
            void omit_field_6_4() const;

            class sequence_6_2_element_mref
              : public mfast::make_aggregate_mref<Test_6_cref::group_6_cref::sequence_6_1_element_cref::sequence_6_2_element_cref>
            {
              typedef mfast::make_aggregate_mref<Test_6_cref::group_6_cref::sequence_6_1_element_cref::sequence_6_2_element_cref> base_type;
              public:
                sequence_6_2_element_mref(
                  mfast::allocator*     alloc,
                  mfast::value_storage* storage,
                  instruction_cptr      instruction);
                ...
                mfast::uint32_mref set_field_6_6() const;
            };

            typedef mfast::make_sequence_mref<sequence_6_2_element_mref> sequence_6_2_mref;
            sequence_6_2_mref set_sequence_6_2() const;
            void omit_sequence_6_2() const;
        };

        typedef mfast::make_sequence_mref<sequence_6_1_element_mref> sequence_6_1_mref;
        sequence_6_1_mref set_sequence_6_1() const;
    };

    group_6_mref set_group_6() const;
};
      ...
      : public mfast::sequence_element_cref
    {
      ...
      public:
          ...
          : public mfast::aggregate_cref
        {
          typedef mfast::aggregate_cref base_type;
          public:
            typedef mfast::group_instruction_ex<group_7_cref> instruction_type;

            typedef const instruction_type* instruction_cptr;
            group_7_cref();
            template <typename T>
            group_7_cref(
              typename std::enable_if<std::is_same<typename T::cref_type, group_7_cref>::value, const mfast::value_storage*>::type storage,
              const T* instruction);

            explicit group_7_cref(const mfast::field_cref& other);
        ...
        group_7_cref get_group_7() const;
        group_7_cref try_get_group_7() const;
    };
  ...
  public:
      ...
      : public mfast::make_aggregate_mref<Test_7_cref::sequence_7_element_cref>
    {
      ...
      public:
        ...
        class group_7_mref
          : public mfast::make_aggregate_mref<Test_7_cref::sequence_7_element_cref::group_7_cref>
        {
          typedef mfast::make_aggregate_mref<Test_7_cref::sequence_7_element_cref::group_7_cref> base_type;
          public:
            group_7_mref();
            template <typename T>
            group_7_mref(
              mfast::allocator*       alloc,
              typename std::enable_if<std::is_same<typename T::cref_type, group_7_cref>::value, mfast::value_storage*>::type   storage,
              const T* instruction);

            explicit group_7_mref(const mfast::field_mref_base& other);
        ...
        group_7_mref set_group_7() const;
        void omit_group_7() const;
    };
  ...
  : public mfast::aggregate_cref
{
  ...
  public:
    ...
    class sequence_8_element_cref
      : public mfast::sequence_element_cref
    {
      typedef mfast::sequence_element_cref base_type;
      public:
        typedef mfast::sequence_instruction_ex<sequence_8_element_cref> instruction_type;
        typedef const instruction_type* instruction_cptr;
        sequence_8_element_cref(
          const mfast::value_storage* storage,
          instruction_cptr            instruction);
        ...
        mfast::decimal_cref get_field_8_3() const;
        mfast::decimal_cref try_get_field_8_3() const;
    };

    typedef mfast::make_sequence_cref<sequence_8_element_cref> sequence_8_cref;
    sequence_8_cref get_sequence_8() const;
    sequence_8_cref try_get_sequence_8() const;
  ...
  : public Test_8_mref_base
{
  ...
  public:
    ...
    class sequence_8_element_mref
      : public mfast::make_aggregate_mref<Test_8_cref::sequence_8_element_cref>
    {
      typedef mfast::make_aggregate_mref<Test_8_cref::sequence_8_element_cref> base_type;
      public:
        sequence_8_element_mref(
          mfast::allocator*     alloc,
          mfast::value_storage* storage,
          instruction_cptr      instruction);
        ...
        mfast::decimal_mref set_field_8_3() const;
        void omit_field_8_3() const;
    };

    typedef mfast::make_sequence_mref<sequence_8_element_mref> sequence_8_mref;
    sequence_8_mref set_sequence_8() const;
};
