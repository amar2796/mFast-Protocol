// simple8.h generated by mFAST from FAST Template. 
  ...
  : public mfast::aggregate_cref
{
  ...
  public:
    ...
    mfast::uint64_cref get_field2() const;
    mfast::uint64_cref try_get_field2() const;
  ...
  : public Test_mref_base
{
  ...
  public:
    ...
    mfast::uint64_mref set_field2() const;
};
