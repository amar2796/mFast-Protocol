// simple6.inl generated by mFAST from FAST Template. 
...
inline void Test_cref::accept(Visitor& visitor)
{
  ...
  visitor.visit(ext_cref<uint32_cref, copy_operator_tag, properties_type< 2> > ((*this)[1]) );
  visitor.visit(ext_cref<uint32_cref, copy_operator_tag, properties_type< 2> > ((*this)[2]) );
}
...
inline void Test_mref::accept(Visitor& visitor)
{
  ...
  visitor.visit(ext_mref<uint32_mref, copy_operator_tag, properties_type< 2> > ((*this)[1]) );
  visitor.visit(ext_mref<uint32_mref, copy_operator_tag, properties_type< 2> > ((*this)[2]) );
}
