// simple5.h generated by mFAST from FAST Template. 
  ...
  : public mfast::aggregate_cref
{
  ...
  public:
    ...
    typedef mfast::nested_message_cref nested_cref;
    nested_cref get_nested() const;
    nested_cref try_get_nested() const;
  ...
  : public Test_mref_base
{
  ...
  public:
    ...
    typedef mfast::nested_message_mref nested_mref;
    nested_mref set_nested() const;
    void link_nested(const nested_mref& ref) const;
    void unlink_nested() const;
};
