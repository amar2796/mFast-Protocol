// simple5.inl generated by mFAST from FAST Template. 
...
inline void Test_cref::accept(Visitor& visitor)
{
  using namespace mfast;
  visitor.visit(ext_cref<uint32_cref, copy_operator_tag, properties_type< 0> > ((*this)[0]) );
  visitor.visit(ext_cref< nested_cref,  group_type_tag, properties_type< 0> > ((*this)[1]) );
}
...
inline void Test_mref::accept(Visitor& visitor)
{
  using namespace mfast;
  visitor.visit(ext_mref<uint32_mref, copy_operator_tag, properties_type< 0> > ((*this)[0]) );
  visitor.visit(ext_mref< nested_mref, group_type_tag, properties_type< 0> > ((*this)[1]) );
}
...
inline Test_cref::nested_cref
Test_cref::get_nested() const
{
  return static_cast<Test_cref::nested_cref>(mfast::aggregate_cref((*this)[1])[0]);
}


inline Test_cref::nested_cref
Test_cref::try_get_nested() const
{
  return static_cast<Test_cref::nested_cref>(mfast::aggregate_cref((*this)[1])[0]);
}

inline Test_mref::nested_mref
Test_mref::set_nested() const
{
  return Test_mref::nested_mref(mfast::aggregate_mref((*this)[1])[0]);
}
