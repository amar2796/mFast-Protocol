// simple9.inl generated by mFAST from FAST Template. 
...
inline void Test_cref::accept(Visitor& visitor)
{
  ...
  visitor.visit(ext_cref< sequence_cref, ext_cref<uint32_cref, none_operator_tag, properties_type< 1> >, ext_cref< typename sequence1_cref::reference, sequence_element_tag,properties_type< 0> > > ((*this)[1]) );
}
...
inline void Test_mref::accept(Visitor& visitor)
{
  ...
  visitor.visit(ext_mref< sequence_mref, ext_mref<uint32_mref, none_operator_tag, properties_type< 1> >, ext_mref< typename sequence1_mref::reference, sequence_element_tag,properties_type< 0> > > ((*this)[1]) );
}
...
inline Test_cref::sequence1_cref
Test_cref::get_sequence1() const
{
  return static_cast<Test_cref::sequence1_cref>((*this)[1]);
}

inline Test_cref::sequence1_cref
Test_cref::try_get_sequence1() const
{
  if ((*this)[1].absent())
...
inline Test_mref::sequence1_mref
Test_mref::set_sequence1() const
{
  return static_cast<Test_mref::sequence1_mref>((*this)[1]);
}

inline
void
Test_mref::omit_sequence1() const
{
  (*this)[1].omit();
}

inline
Test_cref::sequence1_element_cref::sequence1_element_cref(
  const mfast::value_storage*   storage,
  Test_cref::sequence1_element_cref::instruction_cptr instruction)
  : base_type(storage, instruction)
{
}

inline
Test_mref::sequence1_element_mref::sequence1_element_mref(
  mfast::allocator*               alloc,
  mfast::value_storage*         storage,
  Test_mref::sequence1_element_mref::instruction_cptr instruction)
  : base_type(alloc,storage, instruction)
{
}

template <typename Visitor>
inline void Test_cref::sequence1_element_cref::accept(Visitor& visitor)
{
  using namespace mfast;
...
template <typename Visitor>
inline void Test_mref::sequence1_element_mref::accept(Visitor& visitor)
{
  using namespace mfast;
...
inline mfast::uint32_cref
Test_cref::sequence1_element_cref::get_field2() const
{
  return static_cast<mfast::uint32_cref>((*this)[0]);
}

inline mfast::uint32_cref
Test_cref::sequence1_element_cref::try_get_field2() const
{
  if ((*this)[0].absent())
    throw mfast::bad_optional_access();
  return static_cast<mfast::uint32_cref>((*this)[0]);
...
inline mfast::uint32_mref
Test_mref::sequence1_element_mref::set_field2() const
{
  return static_cast<mfast::uint32_mref>((*this)[0]);
}
...
inline
void
Test_mref::sequence1_element_mref::omit_field2() const
{
  (*this)[0].omit();
}

inline mfast::uint32_cref
Test_cref::sequence1_element_cref::get_field3() const
{
  return static_cast<mfast::uint32_cref>((*this)[1]);
}

inline mfast::uint32_cref
Test_cref::sequence1_element_cref::try_get_field3() const
{
  if ((*this)[1].absent())
    throw mfast::bad_optional_access();
  return static_cast<mfast::uint32_cref>((*this)[1]);
...
inline mfast::uint32_mref
Test_mref::sequence1_element_mref::set_field3() const
{
...
inline
void
Test_mref::sequence1_element_mref::omit_field3() const
{
  (*this)[1].omit();
}
