// MDRefreshSample.inl generated by mFAST from FAST Template. 
...
inline void MDRefreshSample_cref::accept(Visitor& visitor)
{
  ...
  visitor.visit(ext_cref< sequence_cref, ext_cref<uint32_cref, none_operator_tag, properties_type< 0> >, ext_cref< typename MDEntries_cref::reference, sequence_element_tag,properties_type< 12> > > ((*this)[4]) );
}
...
inline void MDRefreshSample_mref::accept(Visitor& visitor)
{
  ...
  visitor.visit(ext_mref< sequence_mref, ext_mref<uint32_mref, none_operator_tag, properties_type< 0> >, ext_mref< typename MDEntries_mref::reference, sequence_element_tag,properties_type< 12> > > ((*this)[4]) );
}
...
MDRefreshSample_cref::get_BeginString() const
{
  return static_cast<mfast::ascii_string_cref>((*this)[0]);
}

inline mfast::ascii_string_cref
MDRefreshSample_cref::try_get_BeginString() const
{
  return static_cast<mfast::ascii_string_cref>((*this)[0]);
}

inline mfast::ascii_string_cref
MDRefreshSample_cref::get_MessageType() const
{
  return static_cast<mfast::ascii_string_cref>((*this)[1]);
}

inline mfast::ascii_string_cref
MDRefreshSample_cref::try_get_MessageType() const
{
  return static_cast<mfast::ascii_string_cref>((*this)[1]);
}

inline mfast::ascii_string_cref
MDRefreshSample_cref::get_SenderCompID() const
{
  return static_cast<mfast::ascii_string_cref>((*this)[2]);
}

inline mfast::ascii_string_cref
MDRefreshSample_cref::try_get_SenderCompID() const
{
  return static_cast<mfast::ascii_string_cref>((*this)[2]);
}

inline mfast::ascii_string_mref
MDRefreshSample_mref::set_SenderCompID() const
{
  return static_cast<mfast::ascii_string_mref>((*this)[2]);
}

inline mfast::uint32_cref
MDRefreshSample_cref::get_MsgSeqNum() const
{
  return static_cast<mfast::uint32_cref>((*this)[3]);
}

inline mfast::uint32_cref
MDRefreshSample_cref::try_get_MsgSeqNum() const
{
  return static_cast<mfast::uint32_cref>((*this)[3]);
}

inline mfast::uint32_mref
MDRefreshSample_mref::set_MsgSeqNum() const
{
...
{
  return static_cast<MDRefreshSample_cref::MDEntries_cref>((*this)[4]);
}
...
{
  return static_cast<MDRefreshSample_mref::MDEntries_mref>((*this)[4]);
}
...
inline void MDRefreshSample_cref::MDEntries_element_cref::accept(Visitor& visitor)
{
  ...
  visitor.visit(ext_cref<decimal_cref, std::tuple<delta_operator_tag, delta_operator_tag>, std::tuple<properties_type< 0> , properties_type< 2> > > ((*this)[5]) );
...
inline void MDRefreshSample_mref::MDEntries_element_mref::accept(Visitor& visitor)
{
  ...
  visitor.visit(ext_mref<decimal_mref, std::tuple<delta_operator_tag, delta_operator_tag>, std::tuple<properties_type< 0> , properties_type< 2> > > ((*this)[5]) );
